...
static DisasASI get_asi(DisasContext *dc, int insn, TCGMemOp memop, CPUState *cs)
{
...
static void gen_ld_asi(DisasContext *dc, TCGv dst, TCGv addr,
                       int insn, TCGMemOp memop,CPUState *cs)
{
    DisasASI da = get_asi(dc, insn, memop, cs);
...
static void gen_swap_asi(DisasContext *dc, TCGv dst, TCGv src,
                         TCGv addr, int insn, CPUState *cs)
{
    DisasASI da = get_asi(dc, insn, MO_TEUL, cs);
...
static void gen_ldstub_asi(DisasContext *dc, TCGv dst, TCGv addr, int insn, CPUState *cs)
{
    DisasASI da = get_asi(dc, insn, MO_UB,cs);
...
static void gen_ldf_asi(DisasContext *dc, TCGv addr,
                        int insn, int size, int rd, CPUState *cs)
{
    DisasASI da = get_asi(dc, insn, (size == 4 ? MO_TEUL : MO_TEQ), CPUState *cs);
    TCGv_i32 d32;
    TCGv_i64 d64;
...
static void gen_stf_asi(DisasContext *dc, TCGv addr,
                        int insn, int size, int rd, CPUState *cs)
{
    DisasASI da = get_asi(dc, insn, (size == 4 ? MO_TEUL : MO_TEQ), cs);
    TCGv_i32 d32;
...
static void gen_ldda_asi(DisasContext *dc, TCGv addr, int insn, int rd, CPUState *cs)
{
    DisasASI da = get_asi(dc, insn, MO_TEQ, cs);
...
static void disas_sparc_insn(DisasContext * dc, unsigned int insn,  CPUState *cs)
{
    ...
    case 3:                     /* load/store instructions */
        {
            ...
            if (xop < 4 || (xop > 7 && xop < 0x14 && xop != 0x0e) ||
                ...
                case 0x10:      /* lda, V9 lduwa, load word alternate */
                    gen_ld_asi(dc, cpu_val, cpu_addr, insn, MO_TEUL, cs);
                    break;
                case 0x11:      /* lduba, load unsigned byte alternate */
                    gen_ld_asi(dc, cpu_val, cpu_addr, insn, MO_UB, cs);
                    break;
                case 0x12:      /* lduha, load unsigned halfword alternate */
                    gen_ld_asi(dc, cpu_val, cpu_addr, insn, MO_TEUW, cs);
                    break;
                case 0x13:      /* ldda, load double word alternate */
                    if (rd & 1) {
                        goto illegal_insn;
                    }
                    gen_ldda_asi(dc, cpu_addr, insn, rd, cs);
                    goto skip_move;
                case 0x19:      /* ldsba, load signed byte alternate */
                    gen_ld_asi(dc, cpu_val, cpu_addr, insn, MO_SB, cs);
                    break;
                case 0x1a:      /* ldsha, load signed halfword alternate */
                    gen_ld_asi(dc, cpu_val, cpu_addr, insn, MO_TESW, cs);
                    break;
                case 0x1d:      /* ldstuba -- XXX: should be atomically */
                    gen_ldstub_asi(dc, cpu_val, cpu_addr, insn, cs);
                    break;
                case 0x1f:      /* swapa, swap reg with alt. memory. Also
                                   atomically */
                    CHECK_IU_FEATURE(dc, SWAP);
                    cpu_src1 = gen_load_gpr(dc, rd);
                    gen_swap_asi(dc, cpu_val, cpu_src1, cpu_addr, insn, cs);
                    break;
                ...
                case 0x0b: /* V9 ldx */
                    ...
                    break;
                case 0x18: /* V9 ldswa */
                    gen_ld_asi(dc, cpu_val, cpu_addr, insn, MO_TESL, cs);
                    break;
                case 0x1b: /* V9 ldxa */
                    gen_ld_asi(dc, cpu_val, cpu_addr, insn, MO_TEQ, cs);
                    break;
                ...
                case 0x30: /* V9 ldfa */
                    ...
                    gen_ldf_asi(dc, cpu_addr, insn, 4, rd, cs);
                    gen_update_fprs_dirty(dc, rd);
                    goto skip_move;
                case 0x33: /* V9 lddfa */
                    if (gen_trap_ifnofpu(dc)) {
                    ...
                    gen_ldf_asi(dc, cpu_addr, insn, 8, DFPREG(rd), cs);
                ...
                case 0x32: /* V9 ldqfa */
                    ...
                    gen_ldf_asi(dc, cpu_addr, insn, 16, QFPREG(rd), cs);
                    gen_update_fprs_dirty(dc, QFPREG(rd));
                    goto skip_move;
#endif
                default:
            ...
            skip_move: ;
                ...
                case 0x14: /* sta, V9 stwa, store word alternate */
                    gen_st_asi(dc, cpu_val, cpu_addr, insn, MO_TEUL, cs);
                    break;
                case 0x15: /* stba, store byte alternate */
                    gen_st_asi(dc, cpu_val, cpu_addr, insn, MO_UB, cs);
                    break;
                case 0x16: /* stha, store halfword alternate */
                    gen_st_asi(dc, cpu_val, cpu_addr, insn, MO_TEUW, cs);
                    break;
                case 0x17: /* stda, store double word alternate */
                    if (rd & 1) {
                        goto illegal_insn;
                    }
                    gen_stda_asi(dc, cpu_val, cpu_addr, insn, rd, cs);
                    break;
#endif
#ifdef TARGET_SPARC64
                case 0x0e: /* V9 stx */
                    ...
                    break;
                case 0x1e: /* V9 stxa */
                    gen_st_asi(dc, cpu_val, cpu_addr, insn, MO_TEQ, cs);
                    break;
#endif
                default:
                    goto illegal_insn;
                ...
                case 0x36: /* V9 stqfa */
                    {
                        ...
                        gen_stf_asi(dc, cpu_addr, insn, 16, QFPREG(rd), cs);
                    }
                    break;
                case 0x37: /* V9 stdfa */
                    if (gen_trap_ifnofpu(dc)) {
                ...
                case 0x3e: /* V9 casxa */
                    rs2 = GET_FIELD(insn, 27, 31);
                    cpu_src2 = gen_load_gpr(dc, rs2);
                    gen_casx_asi(dc, cpu_addr, cpu_src2, insn, rd, cs);
                    break;
#else
                case 0x34: /* stc */
                case 0x35: /* stcsr */
                ...
                case 0x3c: /* V9 or LEON3 casa */
                    ...
                    rs2 = GET_FIELD(insn, 27, 31);
                    cpu_src2 = gen_load_gpr(dc, rs2);
                    gen_cas_asi(dc, cpu_addr, cpu_src2, insn, rd, cs);
                    break;
#endif
                default:
                    goto illegal_insn;
...
void gen_intermediate_code(CPUState *cs, TranslationBlock * tb)
{
    ...
    do {
        ...
        disas_sparc_insn(dc, insn, CPU(sparc_env_get_cpu(env)));
